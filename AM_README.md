...
![**Figure** DotPlot (`Seurat`) visualising the differential expression of genes for each AM subcluster ](https://github.com/AlicenJoyHenning/TB_BAL/raw/master/plots/markers_dot.svg)
